    ...
    <script type="text/javascript">
      Gabra = {
        ...
        i18n : {
          ...
          x_more: "<?php echo h(__("{0} more matches")); ?>",
          ...
          etymology: {
             occurs_in: "<?php echo h(__("Occurs in {0} languages, grouped into {1} senses")); ?>",
             more_link: "<?php echo h(__("See the full etymological information at <a href=\"{0}\" target=\"_blank\">Minsel <span class=\"glyphicon glyphicon-new-window\"></span></a>")); ?>",
          },
      ...
      <div class="container">
        ...
        <div class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            <li <?php if ($this->request->getParam('controller') == 'lexemes' && $this->request->getParam('action') == 'search'): ?>class="active"<?php endif ?>>
                <?php echo $this->Html->link(__("Advanced search"), '/lexemes/search') ?>
            </li>
            <li <?php if ($this->request->getParam('controller') == 'roots'): ?>class="active"<?php endif ?>>
